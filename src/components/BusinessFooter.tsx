            ...
            <CardContent>
              <Dialog open={showContactDialog} onOpenChange={setShowContactDialog}>
                <DialogTrigger asChild>
                  <Button className="w-full" size="lg">                    <Mail className="h-4 w-4 mr-2" />
                    문의하기
                  </Button>
                </DialogTrigger>
              <DialogContent className="sm:max-w-lg">                  <DialogHeader>
                  ...
                  {submitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div>
                        <Label htmlFor="contact-message">문의 내용 *</Label>                        <Textarea
                          id="contact-message"
                          required
                          rows={5}
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Button
                ...
                className="w-full"
                onClick={() => {
                  // 피드백도 동일한 폼을 사용하지만 모드를 구분                  setMode('feedback');
                  setFormData({
                    ...formData,
                    subject: '피드백',
                  });
