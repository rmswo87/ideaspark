...
**중요**: 다이어그램의 모든 노드(박스)는 아이디어에서 언급된 실제 기능명을 사용해야 합니다. 예시 텍스트를 그대로 사용하지 마세요.
...
**중요**: Gantt 차트의 모든 작업명은 아이디어에서 언급된 실제 기능명을 사용해야 합니다. "아이디어 기능 1 개발" 같은 예시 텍스트를 그대로 사용하지 마세요.
